    ...
    <div className={styles.StarterPage}>
      <div className={styles.StarterHeader}>
        ...
        <div className={styles.Subtitle}>
          Check our starters to quickly get up and running your next FastStore
          website. Ranging from minimal to complex implementations, FastStore
          Starters are templates developers can use to create new ecommerce
          experiences straightaway.{' '}
        </div>
      </div>
