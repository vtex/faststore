...
Mutated by [`validateCart`](/reference/api/mutations/validateCart).
...
Queried by [`person`](/reference/api/queries/person).
...
Mutated by [`updateSession`](/reference/api/mutations/updateSession).
