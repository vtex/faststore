...
:::tip
We understand, however, that freedom can be scary sometimes. That's why, to help you build your store frontend, we deliver the [Faststore](/tutorials/architecture/2) - a set of libraries that supports integrations with headless ecommerce platforms, provides ecommerce-focused React components and GA4 compatible analytics functions.
:::
