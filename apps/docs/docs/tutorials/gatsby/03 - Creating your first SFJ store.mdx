...
1. Clone the gatsby store to your local machine by running the following command. Notice that your project name must end with `.store`.
...
![](https://vtexhelp.vtexassets.com/assets/docs/src/npxdegitclone___5d45b3298417945933fe8ae495dda989.png)
...
![](https://vtexhelp.vtexassets.com/assets/docs/src/basestore___a0f016760b591ac21caeae30a6107140.gif)
