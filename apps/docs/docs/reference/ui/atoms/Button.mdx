...
<section className="overviewSection">
  <section className="overviewSectionItem">
...
[BuyButton](/reference/ui/molecules/BuyButton) intends to send the user to the checkout/cart step directly.
...
[LinkButton](/reference/ui/molecules/LinkButton) is similar to a button, however acts as a link to navigate users between pages.
