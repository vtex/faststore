...
- Provide a [Label](/reference/ui/atoms/Label) when using input. Descriptive labels help users understand the purpose of a form control.
...
[InputField](/reference/ui/molecules/InputField) wraps a [Input](/reference/ui/atoms/Input) input and its corresponding [Label](/reference/ui/atoms/Label). InputFields are text fields used to get user inputs.
