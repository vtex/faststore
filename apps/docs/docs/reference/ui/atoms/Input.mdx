...
[InputField](/reference/ui/molecules/InputField) wraps an [Input](/reference/ui/atoms/Input) and its corresponding [Label](/reference/ui/atoms/Label). InputFields are text fields used to get user inputs.
