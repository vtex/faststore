---
description: Banners are used for advertising brands, products, and/or collections.
sidebar_custom_props: 
  image: https://vtexhelp.vtexassets.com/assets/docs/src/Banner___852255d4ec6b0e482486918aeba40e66.png
---
