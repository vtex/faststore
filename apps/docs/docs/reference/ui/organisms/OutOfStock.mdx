...
- Place the component near the product and/or indicate to subscribed users that they will be notified when the item returns to stock.

### Don'ts
- Don't use the `OutOfStock` for alert messages, instead use the [Alert component](https://www.faststore.dev/reference/ui/molecules/Alert).
