...
:::caution
If these steps do not work for you, you may not have the latest version of the `@faststore/api` dependency installed. You can reinstall it by running the command `yarn` in your project. If your project uses Gatsby, use the steps described in [Graphiql for gatsby projects](#graphiql-for-gatsby-projects).
:::
