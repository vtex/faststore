...
See the code example to learn how one query from the [Next.js base store product page](https://github.com/vtex-sites/nextjs.store/blob/main/src/pages/%5Bslug%5D/p.tsx) is equivalent to two in the [corresponding page of the Gatsby base store](https://github.com/vtex-sites/gatsby.store/blob/main/src/pages/%5Bslug%5D/p.tsx).
