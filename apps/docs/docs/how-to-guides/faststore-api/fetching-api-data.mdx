...
:::caution
Whenever you make changes to your declared queries you must regenerate the types with the command indicated above. Otherwise, you will not be able to use the data.
:::
...
After you have completed the steps described above, your code should look something like the example below.
