      ...
      <main>
        ...
        <div className="mx-auto px-4 w-full lg:max-w-[1170px]">
          <div className="grid lg:grid-cols-3 lg:gap-24 lg:my-6 my-14 gap-10">
            <div>
              <img src="https://vtexhelp.vtexassets.com/assets/docs/src/rocket___425b51e066a4b8056c14509077fbb307.png" className="w-9" />
            ...
            <div>
              <img src="https://vtexhelp.vtexassets.com/assets/docs/src/code___701a3a9cf0b330050cdc8c6c6ede0154.png" className="w-9" />
            ...
            <div>
              <img src="https://vtexhelp.vtexassets.com/assets/docs/src/data-icon___7fd96a00b6b64a90fcc756a144ea061e.png" className="w-9" />
              <h3 className="my-4 font-VTEXRegular text-lg lg:text-xl leading-8">
          ...
          <p className="text-[16px] text-details pl-8 mb-16">
            DISCLAIMER: Joining the Beta program is mandatory to benefit from VTEX's
        ...
        <div className="bg-[#ffe0ef]">
          <div className="mx-auto p-4 py-16 w-full lg:max-w-[1170px] lg:py-20">
            <div className="lg:flex lg:justify-between mb-5">
              <div className='lg:w-2/5 lg:pr-8'>
                <h2 className="text-2xl font-VTEXRegular text-seriousBlack leading-relaxed mb-0">
                  Bring your preferred Jamstack solutions or quick start with our opinionated tech stack
                </h2>
              ...
              <div className='lg:flex lg:flex-row items-center leading-loose'>
                <div className='lg:grid lg:gap-4'>                  
                  <div>
                    ...
                    <p className="inline mr-10">Develop with any CSS framework</p>
                  </div>
                  <div>
                    <svg role="img" xmlns="http://www.w3.org/2000/svg" fill='#e31c58' className='w-5 h-5 inline-block mr-2' viewBox="0 0 28 28"> <path d="M14 0C6.3 0 0 6.3 0 14C0 21.7 6.3 28 14 28C21.7 28 28 21.7 28 14C28 6.3 21.7 0 14 0ZM12.25 19.95L6.3 14L8.75 11.55L12.25 15.05L19.25 8.05L21.7 10.5L12.25 19.95Z" /> </svg>
            ...
            </div><i className="text-xs float-right">
              * Joining the Beta program is mandatory to benefit from VTEX's
              support, WebOps and Headless CMS.
            </i>
          </div>
        </div>
