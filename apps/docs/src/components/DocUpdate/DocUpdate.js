...
const DocUpdate = () => {
  ...
  if (lastUpdates.length > 0) {
            ...
            <div key={i}>
              <div className="mb-2 leading-9">
                {item.type === 'Fixed' && (
                  ...
                  >
                    <path
                      d="M8.13462 15.7692V15.7692C4.05585 15.7692 0.75 12.4634 0.75 8.38462V8.38462C0.75 4.30585 4.05585 1 8.13462 1V1C12.2134 1 15.5192 4.30585 15.5192 8.38462V8.38462C15.5192 12.4634 12.2134 15.7692 8.13462 15.7692Z"
                      stroke="#142032"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                    ...
                    />
                    <path
                      d="M11.4166 6.74316L7.31408 10.8457L4.85254 8.38419"
                      stroke="#142032"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                ...
                {item.type === 'Added' && (
                  ...
                  >
                    <path
                      d="M8 4.48733C8.33987 4.48733 8.61538 4.76285 8.61538 5.10271V11.6668C8.61538 12.0067 8.33987 12.2822 8 12.2822C7.66013 12.2822 7.38462 12.0067 7.38462 11.6668V5.10271C7.38462 4.76285 7.66013 4.48733 8 4.48733Z"
                      fill="#79A479"
                    />
                    <path
                      d="M4.10256 8.38477C4.10256 8.0449 4.37808 7.76938 4.71795 7.76938H11.2821C11.6219 7.76938 11.8974 8.0449 11.8974 8.38477C11.8974 8.72463 11.6219 9.00015 11.2821 9.00015H4.71795C4.37808 9.00015 4.10256 8.72463 4.10256 8.38477Z"
                      fill="#79A479"
                    />
                    <path
                      d="M8 1.61553C4.2611 1.61553 1.23077 4.64586 1.23077 8.38477C1.23077 12.1237 4.2611 15.154 8 15.154C11.7389 15.154 14.7692 12.1237 14.7692 8.38477C14.7692 4.64586 11.7389 1.61553 8 1.61553ZM0 8.38477C0 3.96613 3.58136 0.384766 8 0.384766C12.4186 0.384766 16 3.96613 16 8.38477C16 12.8034 12.4186 16.3848 8 16.3848C3.58136 16.3848 0 12.8034 0 8.38477Z"
                      fill="#79A479"
                    />
                  </svg>
                )}
              ...
              <div className="pl-4 border-l border-border ml-2 mb-4">
                ...
                {item.docs.map((docItem, j) => (
                  <a
                    key={j}
                    className="block text-text hover:no-underline"
                    href={docItem.path}
                  >
                    {docItem.title}
                  </a>
    ...
    comp = (
      <div className="mb-6">
        <h3 className="inline-block mr-3 text-2xl font-extralight align-middle">
          Documentation Updates
        </h3>
