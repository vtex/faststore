---
title: '  Overview'
sidebar_label: 'headless-cms-overview'
---
...
For each Content Type, different **Sections** will be available to compose that page. Sections represent the content structure of a React component, for example, a Carousel or a Hero.
...
![Hero Section](hhttps://vtexhelp.vtexassets.com/assets/docs/src/headless-example-hero___7cbbc99654d6607f50c013053b1348ca.png)
