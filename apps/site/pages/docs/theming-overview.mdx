...
The **Brandless** theme is made of two complementary layers: **Structural Styles** and **Theme**.
...
You can also add styles to overwrite what was set in the Structure and/or Theme, reaching a state of total flexibility and freedom, or you can throw away all existing FastStore CSS altogether and build it from scratch.
