...
Using your custom font helps to keep a cohesive brand everywhere. Make sure you are using a font that is easy to read in your store, and choosing the font's correct color and text size is essential. Follow the steps below to add a custom font to your store.

1. Go to the `src` folder, create a `fonts` folder.
...
> ℹ️ We recommend using fallback fonts as system fonts to ensure quick rendering, consistent and readable content.
