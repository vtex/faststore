...
1. In your [starter project](https://github.com/vtex-sites/starter.store), create a new file named `soft-blue.scss` in `src/themes`.
...
3. Go to `faststore.config.js` and change the `theme` to `soft-blue`:
