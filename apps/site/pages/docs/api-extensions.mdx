...
{/*WILL WE CONTINUE WITH THIS RECOMMENDATION? If you need data that is not available on the native [FastStore GraphQL schema](https://v1.faststore.dev/reference/api/objects), check the [root object](https://v1.faststore.dev/reference/api/objects).
