...
<ul>
  ...
  <li>
    <details>
      <summary>Query: `ShippingSimulationQuery`</summary>
      <ExtendableQueryTable>
        <td>ShippingSimulation</td>
        <td>Client</td>
        <td>shipping</td>
        <td>
          `PDP`
  ...
  <li>
    <details>
      <summary>Query: `SearchSuggestionsQuery`</summary>
      <ExtendableQueryTable>
  ...
  <li>
    <details>
      <summary>Query: `TopSearchSuggestionsQuery`</summary>
      <ExtendableQueryTable>
        <td>TopSearchSuggestions</td>
        <td>Client</td>
        <td>search</td>
        <td>
          `SearchInput` component from `GlobalSection`.
