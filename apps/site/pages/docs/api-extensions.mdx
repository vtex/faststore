...
That's it, for the sake of exposing the new fields you only need to define these files within the vtex folder. The entire GraphQL creation process is transparent and done in the background by the FastStore CLI.
