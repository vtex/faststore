...
It's not recommendable to add other APIs endpoints to your storefront directly, since this may [impact site performance](https://v1.faststore.dev/how-to-guides/faststore-api/fetching-api-data#best-practices-for-fetching-data). 
