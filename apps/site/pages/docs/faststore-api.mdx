...
- **[Extending queries using fragments](/docs/api-extensions/extending-queries-using-fragments):** Extend GraphQL queries using fragments in FastStore API Extension to add custom fields to native queries
