...
1. Please open a ticket with the [VTEX support team](https://help.vtex.com/support) to request the installation of the FastStore Onboarding app.

2. Create a Catalog for testing and populating your store with features like product listing pages, search functionality, product detail pages, and checkout. Without a Catalog, testing would be incomplete, and developing without it can cause data integration issues, delays, and extra retrofitting effort. 
