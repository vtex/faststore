...
Now that you have an [overview of the app](/docs/getting-started/faststore-onboarding/overview), it's time to kickstart your project. In this guide, you will:

- Create your FastStore project with the FastStore Onboarding app.
- Configure a GitHub repository for your project.
- Generate a live demo preview of your store.
...
| Field             | Description     | 
| ----------------- | --------------- |
| **VTEX Headless CMS** | Choose this option to integrate with [VTEX Headless CMS](https://www.faststore.dev/tutorials/cms/0), VTEX's Content Management solution. |
...
Now that your store is up and running, let's set up your development environment by following the step-by-step instructions in [Setting up the Project](/docs/getting-started/settingup-project).
