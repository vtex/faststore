...
| Field                 | Description                                                                                 |
| --------------------- | ------------------------------------------------------------------------------------------- |
| **VTEX Headless CMS** | Choose this option to integrate with [VTEX Headless CMS](/docs/headless-cms-overview/overview-headless-cms), VTEX's Content Management solution. |
