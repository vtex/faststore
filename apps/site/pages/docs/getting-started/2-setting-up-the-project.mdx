...
Let's make the first level of customization which updates the store's [theme](/docs/themes/overview). For this customization, we are going to use the [Soft Blue theme](/docs/themes/soft-blue) and we will make some updates to it.
...
2. Create a new file named `soft-blue.scss` in `src/themes`. This is going to be the new theme of your store.

3. Add the following styles to `src/themes/soft-blue.scss`:

```scss filename="src/themes/soft-blue.scss"
// ----------------------------------------------------------
// GLOBAL TOKENS
// Theme Soft Blue
// ----------------------------------------------------------
