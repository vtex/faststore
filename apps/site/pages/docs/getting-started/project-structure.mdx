...
- `/.github` - Stores GitHub-related files, including issue templates and workflows.

- `/node_modules` - Saves and installs all the packages that your project depends on into your local files using Yarn.

    </header>
    <Callout type="warning" emoji="⚠️">
    FastStore components use [Sass](https://sass-lang.com/), but you can style them using another tool such as Tailwind. 
    </Callout>
