...
#### CMS Integration
The option available to use a CMS in a FastStore project is [VTEX Headless CMS](https://www.faststore.dev/tutorials/cms/0), a VTEX'S Content Management solution.
