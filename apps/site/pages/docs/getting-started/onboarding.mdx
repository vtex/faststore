...
Now that your store is up and running, let's set up the development environment by following the step-by-step instructions in [Setting up the Project](https://evergreen.faststore.dev/docs/getting-started/settingup-project).
