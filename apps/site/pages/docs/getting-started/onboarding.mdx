...
Once the issue is resolved, you will see the [Repository and Live Store created](#repository-and-live-store-created) scenario and from there let's set up the development environment by following the step-by-step instructions in [Setting up the Project](/tbd).
