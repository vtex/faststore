...
To maintain visual consistency with you store's theme, we recommend using the [global tokens](docs/global-tokens/overview) whenever possible. Also, you can take advantage of the design tokens set provided by [FastStore UI Components](/components).

3. Restart the server and check the color of your `CustomBuyButton` component:
