...
## Importing FastStore UI component style

If you are using a FastStore UI component and you desire to use its styles
you should import it to your FastStore project. To do so, follow the steps below, 
for this example we will override the ProductTitle component within the [`ProductDetails`]() section. 
