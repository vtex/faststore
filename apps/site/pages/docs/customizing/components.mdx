...
#### Step 1 - Creating the stylesheet
Create the stylesheet file and export the component 

1. Open your FastStore project and navigate to the `components`, 
...
Now, you need to create the custom component that will be overwritten, in this case the ProductTitle:

1. In the `components` folder, create the `CustomProductTitle.tsx` file.
...
```
This code creates a custom Product Title component that displays the product title, 
star rating, and a tag indicating that the product is on sale. 
However to make it available, you need to declare this new component in the Product Details, to do so follow the next section.

#### Step 3 - Overriding the section
