...
```scss filename="src/themes/custom-theme.scss"
  ...
  // --------------------------------------------------------
  // FS UI Components
  // --------------------------------------------------------
...
```scss {7} filename="src/themes/custom-theme.scss"
  ...
  // --------------------------------------------------------
  // FS UI Components
  // --------------------------------------------------------
...
```scss {10-13} filename="src/themes/custom-theme.scss"
  ...
  // --------------------------------------------------------
  // FS UI Components
  // --------------------------------------------------------
...
<br></br>
![custom-buy-button-component-code](https://vtexhelp.vtexassets.com/assets/docs/src/custom-buy-button-component-code-1___a97e0aad9d1218f1e0d6f6a576defefb.png)
<br></br>

2. Add the following code to the `CustomBuyButtons.module.scss` file:

```scss filename="CustomBuyButton.module.scss"
.CustomBuyButton[data-custom-buy-button][data-fs-button] {
...
<Callout type="info" emoji="ℹ️">
Consider incorporating a data attribute when utilizing FastStore UI components for building your custom component. Additionally, if necessary, you can leverage the customization data attribute of the component to manage specificity and override issues.
</Callout>
