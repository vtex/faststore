...
In this this guide you'll learn how to customize the styling of a component by using design tokens that align with your store's branding.
The following scenarios for component customization are:

- [Customizing a component's styles using design tokens](/docs/customizing/components#customizing-a-components-styles-using-design-tokens)
- [Customizing a component within a section](/docs/customizing/components#customizing-a-component-within-a-section)
- [Customizing a new component when using override](/docs/customizing/components#customizing-a-new-component-when-using-override)
- [Importing FastStore UI component styles](/docs/customizing/components#importing-faststore-ui-component-styles)
...
FastStore project, follow the steps below. In this example, we will override the 
[`ProductTitle`]() component within the [`ProductDetails`]() section. 

### Before you begin

<Steps>
### Knowledge of component override
As the [Customizing a new component when using override](/docs/customizing/components#customizing-a-new-component-when-using-override)
you should also have a basic understanding of [overriding native components and props](/docs/building-sections/overriding-components-and-props).
Additionally, we recommend to use [CSS Modules](https://nextjs.org/docs/app/building-your-application/styling/css-modules) for styling your new component.

### Create the `overrides` folder
If you don't have the folder `overrides` yet, go to `src` and create the `components` folder. Inside 
`components` create the `overrides` folder tha will be use later on this tutorial.
</Steps>
### Step by step

#### Step 1 - Create the custom component

1. Open your FastStore project and navigate to the `components` folder and 
create the `customProductTitle.module.scss` file. This file is responsible to import the FastStore UI component style.
