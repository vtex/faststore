...
In order to help our breakpoint customization, we use [Include-Media](https://eduardoboucas.github.io/include-media/#features), a Sass library for writing CSS media queries in an easy and maintainable way, using a natural and simplistic syntax. We use 5 basic breakpoints:
...
If you want to override these sizing system, just follow these steps:
