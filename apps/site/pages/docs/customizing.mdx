...
FastStore uses a default theme called `Brandless`, which provides structural styles for your components and pages. Please read [Brandless's page](/brandless) to further information about our themeable architecture.
...
<SectionList grid="column" classes="tokensLinks">
  <SectionItem
    title="Colors"
    actionPath="/global-tokens/colors"
    description={<>The store palette with all the tones needed.</>}
  ></SectionItem>
  <SectionItem
    title="Typography"
    actionPath="/global-tokens/typography"
    description={
      <>
  ...
  <SectionItem
    title="Spacing"
    actionPath="/global-tokens/spacing"
    description={
      <>
  ...
  <SectionItem
    title="Grid & Layout"
    actionPath="/global-tokens/grid-and-layout"
    description={
      <>
  ...
  <SectionItem
    ...
    actionPath="/global-tokens/interactive-controls"
    description={
      <>
  ...
  <SectionItem
    title="Refinements"
    actionPath="/global-tokens/refinements"
    description={
      <>
...
If you want, you can work on `custom-theme.scss` file that's ready to use. Also, we provide two themes as examples: [soft-blue](/soft-blue) and [midnight](/midnight).
