...
If you want, you can work on `custom-theme.scss` file that's ready to use. Also, we provide two themes as examples: [soft-blue](/docs/soft-blue) and [midnight](/docs/midnight).
