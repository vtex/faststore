...
Now, let's make some of our front-end components available for editing at the VTEX Headless CMS by writing the content schemas that represent them.
...
| Key           | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| :------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `title`       | The name that identifies your component in the VTEX Headless CMS app.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
After creating our Section schemas and Content Types, we will declare the Translation Keys in the `translation-keys.json` file. 
