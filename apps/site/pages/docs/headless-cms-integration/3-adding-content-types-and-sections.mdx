...
| **(optional)** `configurationSchemaSets` | Creates a new tab on the page of that Content Type with advanced settings. In our example, the **Custom Page** includes a new tab called SEO with custom SEO settings. Check the [following section](#the-configurationschemasets-property) for more information. |
...
For the **Custom Page**, a custom section named SEO, which allows editors to change the site metadata, was created.
...
Click on **Create New** and check the available Content Type options. Click on **Custom Page** to create a new **Custom Page** and check the SEO tab.
