...
<Callout type="warning" emoji="⚠️">
  If your project already includes the CMS-related files: `content-types.json`, `sections.json`, or `translation-keys.json`, create only the necessary files for your project's requirements.
</Callout>
