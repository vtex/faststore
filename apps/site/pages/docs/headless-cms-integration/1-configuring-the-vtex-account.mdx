...
5. Fill in the **Preview URL** filed with your production URL. This URL activates the button on VTEX Headless CMS for you to preview the changes made on a page. made_Replace the values between curly brackets according to your scenario._

``` 
https://{account}.vtex.app/api/preview
```

6. Fill in the **Production base URL** filed with your store endpoint to preview changes in the Headless CMS before publishing them. _Replace the values between curly brackets according to your scenario._
