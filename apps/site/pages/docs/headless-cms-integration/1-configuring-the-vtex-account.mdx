...
5. Fill in the **Preview URL** field with your production URL. This URL activates the button on VTEX Headless CMS for you to preview the changes made on a page. _Replace the values between curly brackets according to your scenario._
