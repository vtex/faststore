...
Once you have defined these files in the `vtex` folder, the new fields are already available to use. To consume the fields, refer to the [Consuming FastStore API extension with custom components](/docs/api-extensions/consuming-api-extensions)
