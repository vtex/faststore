...
In this guide, you'll learn how to integrate your **FastStore** project with the [**VTEX Checkout**](https://help.vtex.com/en/tutorial/checkout-vtex-overview--7wcprkM7yZUflOqbzAN5SI). The Checkout is responsible for receiving the necessary shopper information to process an order.
...
Before proceeding, please ensure that you have already [configured the custom domain name of your FastStore website](/docs/go-live/2-configuring-external-dns).
