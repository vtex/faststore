...
- Develop your FastStore project with **Next.js** by following the [Getting Started track](/docs/getting-started/0-getting-started-overview).
...
```diff filename="/faststore.config.js"
...
