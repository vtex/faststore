...
# 2. Configuring external DNS for a custom domain
...
### Step 2 - Configuring domains in VTEX account 
...
6. Add the `SITE_HOST` key with the main domain specified in [Configuring domains in VTEX account](/docs/go-live/2-configuring-external-dns#step-2---configuring-domains-in-vtex-account-management) as the value.
