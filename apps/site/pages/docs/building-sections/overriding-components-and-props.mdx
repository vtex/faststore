...
<Callout type="info" emoji="ℹ️">
  When creating a custom component, it's important to choose a name that distinguishes it from the native component. For example, you can use a name like `CustomComponentName`.
</Callout>
