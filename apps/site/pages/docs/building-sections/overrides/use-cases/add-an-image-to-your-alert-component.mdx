...
4. Add the section to the Headless CMS by following the instructions available in [Sending components to the Headless CMS](/docs/building-sections/overrides/sending-components-to-the-headless-cms).
