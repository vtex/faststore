...
<Callout type="warning" emoji="⚠️">
  This documentation is only for Overrides v1. With you want to know more about Overrides v2 or migrate to the newer version, refer to the [Overrides overview](/docs/building-sections/overrides/overrides-overview) and [Migrating overrides v1 to v2](/docs/building-sections/overrides/migration-v1-to-v2) guides.
</Callout>
