...
In this guide, you'll learn how to create a new section for your store and make it available in the [Headless CMS](https://developers.vtex.com/docs/guides/faststore/headless-cms-overview). This solution is useful when your store requires a section not natively available in FastStore.
