...
Keep in mind that customizations made directly in the VTEX Admin through the [Headless CMS](https://www.faststore.dev/docs/headless-cms-overview) takes priority over code-based overrides.
