...
4. Add the new section, `ProductDetailsWithCustomButton` to the `sections.json` file. 
The schema defines how the Headless CMS renders this section.
...
5. Open your terminal and run `faststore cms-sync`.
6. In the VTEX Admin, navigate to **Storefront > Headless CMS** and click on the **Product Details Page**.
7 In the Product Details Page, click the add button (`+`) and add the **Product Details with custom button** section.
8. Customize the section as you desire.
