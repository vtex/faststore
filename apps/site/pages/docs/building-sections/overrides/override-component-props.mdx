...
### Step 3 - Visualizing the component on the page locally

1. Run `yarn dev` in the terminal to start the development server. 
2. Access the localhost URL provided and got to a Product Details Page to see the new Buy Button:
...
### Step 4 - Adding the component to the CMS
...
10. Click `Save` and then `Preview` to verify your changes.

11. If your changes are working, click `Publish` to make the new button available on the production store.
