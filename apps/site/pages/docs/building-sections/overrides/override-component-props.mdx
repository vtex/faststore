...
```tsx filename="ProductDetailsWithCustomButton.tsx" {5,6,7}
import { ProductDetailsSection, getOverriddenSection } from '@faststore/core'
...
To make the section available in the [Headless CMS](https://developers.vtex.com/docs/guides/faststore/headless-cms-overview), follow the steps below:
