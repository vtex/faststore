...
To make the section available in the [Headless CMS](https://developers.vtex.com/docs/guides/faststore/headless-cms-overview), follow the steps below. For these steps we will use the [Sending components to the Headless CMS](https://docs.google.com/document/d/1WemOyBUwjYCBd7rJzABfUyhgiykP5kIQBnt5ur0cZLo/edit) guide to send the component to the Headless CMS.

Access the VTEX Admin and go to the **Storferont > Headless CMS**.
In the step 4 of the [Sending components to the Headless CMS](https://docs.google.com/document/d/1WemOyBUwjYCBd7rJzABfUyhgiykP5kIQBnt5ur0cZLo/edit) guide, add the new section, named `ProductDetailsWithCustomButton` to the `sections.json` file:
...
Complete the remaining steps from the [Sending components to the Headless CMS](https://docs.google.com/document/d/1WemOyBUwjYCBd7rJzABfUyhgiykP5kIQBnt5ur0cZLo/edit) guide.
Delete the native **BuyButton** section.

### Step 3 - Visualizing the component on the page

1. Run `yarn dev` in the terminal to start the development server. Access the CMS preview in your browser and go to the product details page to see the updated `BuyButton` component:
