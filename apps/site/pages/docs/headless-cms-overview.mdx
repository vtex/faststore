---
title: '  Overview'
sidebar_label: 'Introducing VTEX Headless CMS'
---
...
In this guide, you will be presented to **VTEX Headless CMS**, the solution for content management in FastStore projects. By using the Headless CMS, you can empower editors to create, edit, and publish web content independently through the VTEX Admin.
