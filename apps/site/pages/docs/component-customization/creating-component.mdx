...
<Callout type="info" emoji="ℹ️">
  This structure is *suggested*, *but it's not required*. You can place the
  component in any subdirectory of the `src` folder.
</Callout>
...
Now, let's override the component to render it in the Product Details page in the `ProductDetails` section.
...
<Callout type="info" emoji="ℹ️">
  The above function defines the name of the component (`ProductDetails`) and
  which component to override (`Price`). In this case, we are importing the
  `CustomPrice` component from the `../Price` file.
</Callout>
