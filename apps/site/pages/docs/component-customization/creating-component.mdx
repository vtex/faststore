...
|   |   |
|---|---|
| ![faststore-component](https://vtexhelp.vtexassets.com/assets/docs/src/faststore-component___9fda96b01fa69408c634fe9d4a7b754d.png) The **FastStore `Price` component** displays the price of a given product, discount and total values.| ![custom-component](https://vtexhelp.vtexassets.com/assets/docs/src/custom-component___c0f09a42811eea77e7fc986afd8e5ab3.png) The **custom `Price` component** created can display any information that you set. In this case it renders the name `Price`|
