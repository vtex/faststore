...
<Callout type="warning" emoji="⚠️">
  ...
  fixes provided by VTEX for that component. We hihgly recommend you to pass
...
[Native sections](/tbd) are made up of different components that can be customized or overridden to improve their functionality or appearance in the storefront.
...
<Callout type="info" emoji="ℹ️">
  The `@faststore/core` package provides by default native sections and you can
  check out the available native sections on
  [TBD-link-to-native-sections-list](/tbd).
</Callout>
...
In this step, learn how to override or pass additional props to a component to add a new functionality
to the component or change its apperance.
