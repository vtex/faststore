...
<Callout type="warning" emoji="⚠️">
  The properties changed via Headless CMS overlap the changes made through
  [override](/docs/component-customization/overriding-a-native-component). For
...
- [Override native component's props](/docs/component-customization/adding-extra-properties-to-a-native-component): Modify the behavior of a specific component by passing additional props to it in your store code.
