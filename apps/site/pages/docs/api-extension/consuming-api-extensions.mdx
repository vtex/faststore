---
title: 'Step 3 - Consuming FastStore API extension'
...
- Here is the first time we mention PageProvider should we give a further explanation?
- The hooks available seems to be a prerequisite before consuming data from new sections. Is that right?
```

In this guide you'll learn how to consume new fields from [custom sections](/docs/building-sections/creating-a-new-section) and [overridable components](/docs/building-sections/overriding-components-and-props).
...
```
Questions that this doc should answer:
- What should I expect as an outcome of this topic?
- After declaring the usePLP, what should I do to expose? Run any CLI command?
- Do I need the folder structure created in the previous guides?
```
