...
export const FilterPropsSection = ({ component }) => {
  ...
  const { filterProps, facetsProps, facetBooleanItemProps, facetRangeProps } = useSSG()
  return {
    Filter: <PropsSection propsList={filterProps} />,
    Facets: <PropsSection propsList={facetsProps} />,
    FacetBooleanItem: <PropsSection propsList={facetBooleanItemProps} />,
    FacetRange: <PropsSection propsList={facetRangeProps} />,
  }[component]
}
...
```tsx
import { Filter, Facets, FacetBoolean, FacetBooleanItem, FacetRange } from '@faststore/ui'
```
...
<FilterPropsSection component="Facets" />

### FacetBooleanItem

<FilterPropsSection component="FacetBooleanItem" />

### FacetRange

<FilterPropsSection component="FacetRange" />
...
<TokenTable>
  ...
  />
  <TokenRow
    token="--fs-filter-title-text-size"
    value="var(--fs-text-size-2)"
  />
  <TokenRow
    token="--fs-filter-title-line-height"
    value="1.25"
  />
</TokenTable>
...
<TokenTable>
  ...
  />
  <TokenRow token="--fs-filter-list-item-label-text-size" value="var(--fs-text-size-2)" />
  <TokenRow
    token="--fs-filter-list-item-label-line-height"
    value="1.25"
  />
</TokenTable>
