...
export const propsOutOfStockTitle = [
  {
    name: 'testId',
    type: 'string',
    description:
  ...
  },
  {
    ...
    description: 'Attribute used for polymorphic component.',
  },
  {
    name: 'children',
    type: 'ReactNode',
    description: 'A react component to be used as the title.',
    required: true,
  },
]

<PropsSection propsList={propsOutOfStockTitle} />
