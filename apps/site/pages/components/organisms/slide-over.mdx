...
export const getStaticProps = () => {
  ...
  const components = ['SlideOver.tsx']
  const [slideOverProps] = getComponentPropsFrom(slideOverPath, components)
  return {
    props: {
...
<SlideOverPropsSection name="SlideOverHeader" />
