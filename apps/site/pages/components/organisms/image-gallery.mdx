...
export const propsImageGallery = [
  {
    name: 'testId',
    type: 'string',
    description:
  ...
  },
  {
    ...
    description: 'List of images that should be rendered.',
    required: true,
  },
]

<PropsSection propsList={propsImageGallery} />

### Image Gallery Selector

export const propsImageGallerySelector = [
  {
    name: 'testId',
    type: 'string',
    description:
  ...
  },
  {
    ...
    description: 'Event handler for clicks on each thumbnail.',
    required: true,
  },
  {
    name: 'currentImageIdx',
    type: 'number',
    description: 'The currently active thumbnail.',
    required: true,
  },
  {
    name: 'ImageComponent',
    type: 'FunctionComponent<{ url: string alternateName?: string}>',
    description:
...
<PropsSection propsList={propsImageGallerySelector} />
