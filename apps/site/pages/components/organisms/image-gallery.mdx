...
We provide a customization for the Image Gallery Selector's thumbnail position with the prop `imagePosition`. You can check the first image changing its position on the examples below:
