...
The `ImagePosition` prop sets the image position in the thumbnail and the gallery. You can check the first image changing its position on the examples below:
