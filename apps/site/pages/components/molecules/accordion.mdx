...
@import '@faststore/ui/src/components/molecules/AccordionItem/styles.scss';
@import '@faststore/ui/src/components/molecules/AccordionButton/styles.scss';
@import '@faststore/ui/src/components/molecules/AccordionPanel/styles.scss';
