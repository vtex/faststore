...
Combine `SearchHistory`, `SearchTop` and `SearchAutoComplete` and `SearchProducts` to show all options in `SearchDropdown`. This component is part of the [Search](/components/search) feature.
...
export const propsSearchDropdown = [
  {
    name: 'testId',
    type: 'string',
    description:
      'ID to find this component in testing tools (e.g.: cypress, testing library, and jest).',
    default: 'fs-search-dropdown',
  },
  {
    name: 'term',
    type: 'string',
  ...
  },
  {
    ...
    type: 'ReactNode',
    description: 'A React component that will be rendered as an SearchHistory.',
    required: true,
  },
  {
    name: 'searchTopComponent',
    type: 'ReactNode',
    description: 'A React component that will be rendered as an SearchTop.',
    required: true,
  },
  {
...
<PropsSection propsList={propsSearchDropdown} />
