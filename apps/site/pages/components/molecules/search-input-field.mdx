...
An [InputField](/components/molecules/input-field) with a search button, the Search Input Field is part of the [Search](/components/search) feature.
...
<TokenTable>
  ...
  />
  <TokenRow
    token="--fs-search-input-field-icon-color"
