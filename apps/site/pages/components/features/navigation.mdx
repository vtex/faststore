...
This feature is intended to group the main store's page header components. These components perform specific functions such as navigation among the store pages, navigation to the login flow and others.
