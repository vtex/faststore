...
There is an available example of the usage of all the related components in the `<Navbar />` component on our [core](https://github.com/vtex/faststore/tree/main/packages/core/src/components/navigation/Navbar/Navbar.tsx) application.
