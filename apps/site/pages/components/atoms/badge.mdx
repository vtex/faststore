...
### Import Styles to your storefront project:

1. In the `src/components` folder, create a CSS Module for the Badge component.
Name it `Badge.module.scss`.

2. In the `Badge.module.scss` file, add the following:
