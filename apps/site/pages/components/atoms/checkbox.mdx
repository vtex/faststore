...
[CheckboxField](/components/molecules/checkbox-field) wraps a [Checkbox](/components/atoms/checkbox) input and its corresponding [Label](/reference/ui/atoms/Label).
