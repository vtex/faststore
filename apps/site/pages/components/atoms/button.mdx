...
<Tabs items={['Example', 'Code']} defaultIndex="0">
  <Tab>
    ...
    <Button variant="secondary">Secondary</Button>
    <Button variant="tertiary">Tertiary</Button>
    <Button variant="primary" icon={<ShoppingCart />} iconPosition="left">Button w/ Icon</Button>
...
Import the component from <a href="https://www.faststore.dev/components/get-started-faststore-ui">@faststore/ui</a>
