...
<SectionItem>
  ...
  [IconButton](/reference/ui/molecules/IconButton) is a button which content is only
  an icon, without any label.
</SectionItem>
<SectionItem>
  <BuyButton>Buy Now</BuyButton>
  [BuyButton](/reference/ui/molecules/BuyButton) intends to send the user to the
  checkout/cart step directly.
</SectionItem>
<SectionItem>
  <LinkButton>Link Button</LinkButton>
  [LinkButton](/reference/ui/molecules/LinkButton) is similar to a button, however
