...
<main className="nx-main">
      ...
      <article>
        ...
        <div className="nx-hero-buttons">
          ...
          <a
            ...
            target="_blank"
            class="nx-button nx-button-tertiary"
          >
            {`Join Waiting List`}
          </a>
        </div>
  ...
  <section className="nx-features">
    <ul className="nx-lading-grid">
      <li>
        ...
        <h3 className="nx-h3">{`Start fast with Starters optimized for performance`}</h3>
        <p>
  ...
  <section className="nx-banner">
    <div className="nx-lading-grid">
      <h2 className="nx-h2">
        {`Go live with the full VTEX solution for building lightning-fast shopping
        experiences.`}
      </h2>
      <a
        href="/docs"
