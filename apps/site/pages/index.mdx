...
<main className="nx-main">
      ...
      <article>
        ...
        <div className="nx-hero-buttons">
          <a
            ...
            target="_blank"
            className="nx-button-primary inverse"
          >
            {`View Live Demo`}
          </a>
          <a
  ...
  <section className="nx-section">
    <div className="nx-section-wrapper nx-lading-grid">
      <article>
        ...
        <a href="/components" target="_blank" className="nx-button-primary">
          {`Explore Our Components`}
        </a>
      </article>
      <div className="nx-section-code">
        ```tsx
  ...
  <section className="nx-section">
    <div className="nx-section-wrapper nx-lading-grid">
      <article>
        ...
        <a href="/" target="_blank" className="nx-button-primary">
          {`Connect Your Data`}
        </a>
      </article>
  ...
  <section className="nx-banner">
    <div className="nx-lading-grid">
      ...
      <a href="/docs" target="_blank" className="nx-button-primary inverse">
        {`Learn More`}
      </a>
    </div>
  </section>
