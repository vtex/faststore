...
export const SearchPageQuery = {
  query: process.env.NODE_ENV === 'production' ? undefined : "query SearchPageQuery($from: Int = 0, $to: Int = 11, $fullText: String, $selectedFacets: [VTEX_SelectedFacetInput!], $orderBy: String = \"\", $hideUnavailableItems: Boolean = false) {\n  vtex {\n    productSearch(\n      from: $from\n      to: $to\n      hideUnavailableItems: $hideUnavailableItems\n      simulationBehavior: skip\n      orderBy: $orderBy\n      fullText: $fullText\n      selectedFacets: $selectedFacets\n    ) {\n      products {\n        id: productId\n        productName\n        linkText\n        items {\n          itemId\n          images {\n            imageUrl\n            imageText\n          }\n        }\n      }\n      recordsFiltered\n    }\n    searchMetadata(fullText: $fullText, selectedFacets: $selectedFacets) {\n      title: titleTag\n      description: metaTagDescription\n    }\n    facets(\n      fullText: $fullText\n      selectedFacets: $selectedFacets\n      operator: or\n      behavior: \"Static\"\n      removeHiddenFacets: true\n    ) {\n      breadcrumb {\n        href\n        name\n      }\n      facets {\n        name\n        type\n        values {\n          key\n          name\n          value\n          selected\n          quantity\n          range {\n            from\n            to\n          }\n        }\n      }\n    }\n  }\n}\n",
  sha256Hash: "5491f2afeefb4ac15993415d6e92a94b5d5da6e4bd6b338eb5ec2491063da40a",
