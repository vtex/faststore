...
export type ProductSummary_ProductFragment = { slug: string, sku: string, name: string, gtin: string, unitMultiplier: number | null, id: string, brand: { name: string, brandName: string }, isVariantOf: { productGroupID: string, name: string, skuVariants: { allVariantsByName: any | null, activeVariations: any | null, slugsMap: any | null, availableVariations: any | null } | null }, image: Array<{ url: string, alternateName: string }>, offers: { lowPrice: number, lowPriceWithTaxes: number, offers: Array<{ availability: string, price: number, listPrice: number, listPriceWithTaxes: number, priceWithTaxes: number, quantity: number, seller: { identifier: string } }> }, additionalProperty: Array<{ propertyID: string, name: string, value: any, valueReference: any }>, advertisement: { adId: string, adResponseId: string } | null };
...
export type ProductDetailsFragment_ProductFragment = { sku: string, name: string, gtin: string, description: string, unitMultiplier: number | null, id: string, isVariantOf: { name: string, productGroupID: string, skuVariants: { activeVariations: any | null, slugsMap: any | null, availableVariations: any | null } | null }, image: Array<{ url: string, alternateName: string }>, brand: { name: string }, offers: { lowPrice: number, lowPriceWithTaxes: number, offers: Array<{ availability: string, price: number, priceWithTaxes: number, listPrice: number, listPriceWithTaxes: number, seller: { identifier: string } }> }, additionalProperty: Array<{ propertyID: string, name: string, value: any, valueReference: any }> };
...
export type ServerListOrdersQueryQuery = { accountName: string | null, listUserOrders: { list: Array<{ orderId: string | null, creationDate: string | null, clientName: string | null, totalValue: number | null, status: string | null, statusDescription: string | null, ShippingEstimatedDate: string | null, currencyCode: string | null, items: Array<{ seller: string | null, quantity: number | null, description: string | null, ean: string | null, refId: string | null, id: string | null, productId: string | null, sellingPrice: number | null, price: number | null } | null> | null, customFields: Array<{ type: string | null, value: Array<string | null> | null } | null> | null } | null> | null, paging: { total: number | null, pages: number | null, currentPage: number | null, perPage: number | null } | null } | null };

export type ServerProfileQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type ServerProfileQueryQuery = { accountName: string | null, accountProfile: { name: string | null, email: string | null, id: string | null } };

export type ServerSecurityQueryVariables = Exact<{ [key: string]: never; }>;


export type ServerSecurityQuery = { accountName: string | null, userDetails: { email: string | null } };

export type ServerUserDetailsQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type ServerUserDetailsQueryQuery = { accountName: string | null, userDetails: { name: string | null, email: string | null, role: Array<string | null> | null, orgUnit: string | null } };
...
export type ClientManyProductsQueryQuery = { search: { products: { pageInfo: { totalCount: number }, edges: Array<{ node: { slug: string, sku: string, name: string, gtin: string, unitMultiplier: number | null, id: string, brand: { name: string, brandName: string }, isVariantOf: { productGroupID: string, name: string, skuVariants: { allVariantsByName: any | null, activeVariations: any | null, slugsMap: any | null, availableVariations: any | null } | null }, image: Array<{ url: string, alternateName: string }>, offers: { lowPrice: number, lowPriceWithTaxes: number, offers: Array<{ availability: string, price: number, listPrice: number, listPriceWithTaxes: number, priceWithTaxes: number, quantity: number, seller: { identifier: string } }> }, additionalProperty: Array<{ propertyID: string, name: string, value: any, valueReference: any }>, advertisement: { adId: string, adResponseId: string } | null } }> } } };
...
export type ClientProductGalleryQueryQuery = { redirect: { url: string | null } | null, search: { products: { pageInfo: { totalCount: number } }, facets: Array<{ __typename: 'StoreFacetBoolean', key: string, label: string, values: Array<{ label: string, value: string, selected: boolean, quantity: number }> } | { __typename: 'StoreFacetRange', key: string, label: string, min: { selected: number, absolute: number }, max: { selected: number, absolute: number } }>, metadata: { isTermMisspelled: boolean, logicalOperator: string, fuzzy: string | null } | null } };
...
export type ClientProductQueryQuery = { product: { sku: string, name: string, gtin: string, description: string, unitMultiplier: number | null, id: string, isVariantOf: { name: string, productGroupID: string, skuVariants: { activeVariations: any | null, slugsMap: any | null, availableVariations: any | null } | null }, image: Array<{ url: string, alternateName: string }>, brand: { name: string }, offers: { lowPrice: number, lowPriceWithTaxes: number, offers: Array<{ availability: string, price: number, priceWithTaxes: number, listPrice: number, listPriceWithTaxes: number, seller: { identifier: string } }> }, additionalProperty: Array<{ propertyID: string, name: string, value: any, valueReference: any }> } };
...
export type ClientSearchSuggestionsQueryQuery = { search: { suggestions: { terms: Array<{ value: string }>, products: Array<{ slug: string, sku: string, name: string, gtin: string, unitMultiplier: number | null, id: string, brand: { name: string, brandName: string }, isVariantOf: { productGroupID: string, name: string, skuVariants: { allVariantsByName: any | null, activeVariations: any | null, slugsMap: any | null, availableVariations: any | null } | null }, image: Array<{ url: string, alternateName: string }>, offers: { lowPrice: number, lowPriceWithTaxes: number, offers: Array<{ availability: string, price: number, listPrice: number, listPriceWithTaxes: number, priceWithTaxes: number, quantity: number, seller: { identifier: string } }> }, additionalProperty: Array<{ propertyID: string, name: string, value: any, valueReference: any }>, advertisement: { adId: string, adResponseId: string } | null }> }, products: { pageInfo: { totalCount: number } }, metadata: { isTermMisspelled: boolean, logicalOperator: string, fuzzy: string | null } | null } };
...
export type ValidateSessionMutation = { validateSession: { locale: string, channel: string | null, country: string, addressType: string | null, postalCode: string | null, city: string | null, refreshAfter: string | null, deliveryMode: { deliveryChannel: string, deliveryMethod: string, deliveryWindow: { startDate: string, endDate: string } | null } | null, geoCoordinates: { latitude: number, longitude: number } | null, currency: { code: string, symbol: string }, person: { id: string, email: string, givenName: string, familyName: string } | null, b2b: { customerId: string, isRepresentative: boolean | null, unitName: string | null, unitId: string | null, firstName: string | null, lastName: string | null, userName: string | null, userEmail: string | null, savedPostalCode: string | null } | null, marketingData: { utmCampaign: string | null, utmMedium: string | null, utmSource: string | null, utmiCampaign: string | null, utmiPage: string | null, utmiPart: string | null } | null } | null };
...
export type ServerManyProductsQueryQuery = { search: { products: { pageInfo: { totalCount: number }, edges: Array<{ node: { slug: string, sku: string, name: string, gtin: string, unitMultiplier: number | null, id: string, brand: { name: string, brandName: string }, isVariantOf: { productGroupID: string, name: string, skuVariants: { allVariantsByName: any | null, activeVariations: any | null, slugsMap: any | null, availableVariations: any | null } | null }, image: Array<{ url: string, alternateName: string }>, offers: { lowPrice: number, lowPriceWithTaxes: number, offers: Array<{ availability: string, price: number, listPrice: number, listPriceWithTaxes: number, priceWithTaxes: number, quantity: number, seller: { identifier: string } }> }, additionalProperty: Array<{ propertyID: string, name: string, value: any, valueReference: any }>, advertisement: { adId: string, adResponseId: string } | null } }> }, metadata: { isTermMisspelled: boolean, logicalOperator: string, fuzzy: string | null } | null } };
