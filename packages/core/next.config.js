        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' *.preview.vtex.app *.vtexassets.com *.vtexcommercestable.com *.vtexcommercebeta.com https://www.googletagmanager.com https://www.google-analytics.com https://tagmanager.google.com",
              "style-src 'self' 'unsafe-inline' *.preview.vtex.app *.vtexassets.com https://fonts.googleapis.com",
              "img-src 'self' data: blob: *.preview.vtex.app *.vtexassets.com *.vteximg.com.br https://www.google-analytics.com https://www.googletagmanager.com",
              "font-src 'self' data: *.preview.vtex.app *.vtexassets.com https://fonts.gstatic.com",
              "connect-src 'self' *.preview.vtex.app *.vtexassets.com *.vtexcommercestable.com *.vtexcommercebeta.com https://www.google-analytics.com https://analytics.google.com https://www.googletagmanager.com",
              "frame-src 'self' *.preview.vtex.app",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
