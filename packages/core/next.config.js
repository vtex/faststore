...
const { buildI18nDomains, buildI18nLocales } = require('./i18n')

// Load locales settings (generated by CLI during build - current mock file)
const localesSettings = require('./locales-settings.json')
...
const nextConfig = {
  ...
  i18n: {
    locales: buildI18nLocales(localesSettings),
