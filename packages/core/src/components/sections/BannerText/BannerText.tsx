...
function BannerTextWithDefaultComponents(props: BannerTextProps) {
  return (
    <DefaultComponentsProvider value={BannerTextDefaultComponents}>
      <BannerText {...props} />
    </DefaultComponentsProvider>
  )
}

export default BannerTextWithDefaultComponents
