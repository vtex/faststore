...
<TokenTable title="Global Token" description="Value">
  ...
  <TokenRow token="--fs-color-focus-ring-danger" value="#fee1e1" isColor />
</TokenTable>

### Situations

<TokenTable title="Global Token" description="Value">
  <TokenRow token="--fs-color-success-text" value="#368369" isColor />
  <TokenRow token="--fs-color-success-bkg" value="#cee8de" isColor />
  <TokenRow
  ...
  <TokenRow
    ...
    isColor
  />
  <TokenRow token="--fs-color-warning-bkg" value="#f6e0ba" isColor />
  <TokenRow
