...
import { useSessionSettings } from 'src/sdk/session/useSessionSettings'
...
function App({ Component, pageProps }: AppProps) {
  ...
  // Initialize session with settings from SDK (fetched server-side in getStaticProps)
  useSessionSettings(pageProps.storeSettings)
