...
function CardImage(_ref) {
  ...
  return React.createElement(themeUi.Flex, {
    variant: "card.image"
  }, React.createElement(themeUi.Flex, Object.assign({}, linkProps), React.createElement(themeUi.Image, {
...
function CardInfo(_ref) {
  ...
  return React.createElement(themeUi.Flex, {
    variant: "card.info"
  }, title && React.createElement(themeUi.Heading, {
    variant: "card.info.title"
  }, title), description && React.createElement(themeUi.Text, {
...
exports.CardInfoAction = CardInfoAction;
exports.baseTheme = theme;
exports.cardTheme = CardTheme;
//# sourceMappingURL=store-ui.cjs.development.js.map
