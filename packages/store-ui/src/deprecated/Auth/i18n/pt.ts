export default {
  ...
  'login.page.emailAndPassword.signUpForm.title':
    'Valide o email crie uma nova senha',
  'login.page.emailAndPassword.signUpForm.subTitle':
    'Insira o código enviado para {email} e crie uma nova senha',
  ...
  'login.page.emailAndPassword.signUpForm.invalidPassword':
    'Senha inválida. Sua senha deve conter no mínimo oito dígitos, um dígito minúsculo e outro maiúsculo, e ao menos 1 número',
  'login.page.emailAndPassword.signUpForm.passwordDoNotMatch':
    'Senhas nāo coincidem',
  ...
  'login.page.emailAndPassword.signInForm.forgotPassword':
    'Esqueci minha senha',
  ...
  'login.page.emailAndPassword.signInForm.authError':
    'Algo de errado aconteceu. Por favor tente outra vez',
  ...
  'login.page.emailVerification.accessCodeForm.title':
    'Entre com o codigo de acesso enviado ao seu email',
  'login.page.emailVerification.accessCodeForm.codePlaceholder':
    'Adicione seu codigo de acesso',
  'login.page.emailVerification.accessCodeForm.invalidAccessCode':
    'Insira um codigo de 6 digitos valido',
  'login.page.emailVerification.accessCodeForm.authError':
    'Algo deu errado com o seu codigo de acesso. Por favor, confira o numero e tente outra vez',
  ...
  'login.page.externalOAuth.title': 'Entrando',
  'login.page.externalOAuth.error':
    'Entrar usando o provedor de login falhou. Clique no botao abaixo para tentar novamente',
  'login.page.externalOAuth.tryAgain': 'Tentar novamente',
}
