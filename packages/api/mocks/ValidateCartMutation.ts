...
export const checkoutOrderFormValidFetch = {
  path: '/api/checkout/pub/orderForm/edbe3b03c8c94827a37ec5a6a4648fd2?refreshOutdatedData=true&sc=1',
  init: {
    method: 'POST',
...
export const checkoutOrderFormItemsValidFetch = {
  path: '/api/checkout/pub/orderForm/edbe3b03c8c94827a37ec5a6a4648fd2/items?allowOutdatedData=paymentData&sc=1',
  init: {
    method: 'PATCH',
    headers: {
...
export const checkoutOrderFormCustomDataValidFetch = {
  path: '/api/checkout/pub/orderForm/edbe3b03c8c94827a37ec5a6a4648fd2/customData/faststore/cartEtag',
  init: {
    method: 'PUT',
    headers: { 'content-type': 'application/json', 'X-FORWARDED-HOST': '' },
...
export const productSearchPage1Count1Fetch = {
  path: '/api/io/_v/api/intelligent-search/product_search/trade-policy/1?page=1&count=1&query=sku%3A2737806&sort=&fuzzy=auto&locale=en-US&show-invisible-items=true&hideUnavailableItems=false',
  init: undefined,
  options: {
    account: 'storeframework',
    environment: 'vtexcommercestable',
