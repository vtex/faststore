...
export const checkoutOrderFormItemsInvalidFetch = {
  ...
  init: {
    method: 'PATCH',
    headers: { 'content-type': 'application/json' },
    body: '{"orderItems":[{"quantity":1,"seller":"1","id":"18643698","index":0,"attachments":[]},{"quantity":1,"seller":"1","id":"97907082","index":1,"attachments":[]},{"quantity":1,"seller":"1","id":"64953394","index":2,"attachments":[]},{"quantity":1,"seller":"1","id":"85095548","index":3,"attachments":[]},{"quantity":1,"seller":"1","id":"1191988","index":4,"attachments":[]}]}',
  },
  result: JSON.parse(
