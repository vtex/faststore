...
export const catalogBrandListFetch = {
  info:
    'https://storeframework.vtexcommercestable.com.br/api/catalog_system/pub/brand/list',
  init: undefined,
  result: JSON.parse(
...
export const catalogCategory3Fetch = {
  info:
    'https://storeframework.vtexcommercestable.com.br/api/catalog_system/pub/category/tree/3',
  init: undefined,
  result: JSON.parse(
...
export const catalogPageTypeSkechers = {
  info:
    'https://storeframework.vtexcommercestable.com.br/api/catalog_system/pub/portal/pagetype/skechers',
  init: undefined,
  result: JSON.parse(
...
export const catalogPageTypeAdidas = {
  info:
    'https://storeframework.vtexcommercestable.com.br/api/catalog_system/pub/portal/pagetype/adidas',
  init: undefined,
  result: JSON.parse(
...
export const catalogPageTypeAcer = {
  info:
    'https://storeframework.vtexcommercestable.com.br/api/catalog_system/pub/portal/pagetype/acer',
  init: undefined,
  result: JSON.parse(
...
export const catalogPageTypeIRobot = {
  info:
    'https://storeframework.vtexcommercestable.com.br/api/catalog_system/pub/portal/pagetype/irobot',
  init: undefined,
  result: JSON.parse(
...
export const catalogPageTypeBrand = {
  info:
    'https://storeframework.vtexcommercestable.com.br/api/catalog_system/pub/portal/pagetype/brand',
  init: undefined,
  result: JSON.parse(
