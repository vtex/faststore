...
export const catalogCategory3Fetch = {
  path: '/api/catalog_system/pub/category/tree/3',
  init: undefined,
  options: {
    account: 'storeframework',
    environment: 'vtexcommercestable',
...
export const catalogPageTypeSkechers = {
  path: '/api/catalog_system/pub/portal/pagetype/skechers',
  init: undefined,
  options: {
    account: 'storeframework',
    environment: 'vtexcommercestable',
...
export const catalogPageTypeAdidas = {
  path: '/api/catalog_system/pub/portal/pagetype/adidas',
  init: undefined,
  options: {
    account: 'storeframework',
    environment: 'vtexcommercestable',
...
export const catalogPageTypeAcer = {
  path: '/api/catalog_system/pub/portal/pagetype/acer',
  init: undefined,
  options: {
    account: 'storeframework',
    environment: 'vtexcommercestable',
...
export const catalogPageTypeIRobot = {
  path: '/api/catalog_system/pub/portal/pagetype/irobot',
  init: undefined,
  options: {
    account: 'storeframework',
    environment: 'vtexcommercestable',
...
export const catalogPageTypeBrand = {
  path: '/api/catalog_system/pub/portal/pagetype/brand',
  init: undefined,
  options: {
    account: 'storeframework',
    environment: 'vtexcommercestable',
