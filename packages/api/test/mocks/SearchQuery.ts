...
export const productSearchCategory1Fetch = {
  info: 'https://storeframework.vtexcommercestable.com.br/api/intelligent-search/v1/product-search/category-1/office/?from=0&to=4&sc=1&locale=en-US&hideUnavailableItems=false&simulationBehavior=skip&showSponsored=false&allowRedirect=false',
  init: {
...
export const attributeSearchCategory1Fetch = {
  info: 'https://storeframework.vtexcommercestable.com.br/api/intelligent-search/v1/facets/category-1/office/?from=0&to=4&sc=1&locale=en-US&hideUnavailableItems=false&simulationBehavior=skip&showSponsored=false&allowRedirect=false',
  init: {
    headers: { 'X-FORWARDED-HOST': '', 'content-type': 'application/json' },
  },
  options: undefined,
