...
export type useAsyncProductQueryQuery = { vtex: { product: Maybe<{ productId: Maybe<string>, productName: Maybe<string>, description: Maybe<string>, linkText: Maybe<string>, items: Maybe<Array<Maybe<{ itemId: Maybe<string>, images: Maybe<Array<Maybe<{ imageUrl: Maybe<string>, imageText: Maybe<string> }>>>, sellers: Maybe<Array<Maybe<{ commertialOffer: Maybe<{ AvailableQuantity: Maybe<number>, ListPrice: Maybe<number>, Price: Maybe<number> }> }>>> }>>> }> } };
