...
running command...
$ faststore (--version)
@faststore/cli/3.99.0-dev.0 linux-x64 node-v20.20.1
...
_See code: [dist/commands/build.js](https://github.com/vtex/faststore/blob/v3.99.0-dev.0/dist/commands/build.js)_
...
_See code: [dist/commands/cms-sync.js](https://github.com/vtex/faststore/blob/v3.99.0-dev.0/dist/commands/cms-sync.js)_
...
_See code: [dist/commands/create.js](https://github.com/vtex/faststore/blob/v3.99.0-dev.0/dist/commands/create.js)_
...
_See code: [dist/commands/dev.js](https://github.com/vtex/faststore/blob/v3.99.0-dev.0/dist/commands/dev.js)_
...
_See code: [dist/commands/start.js](https://github.com/vtex/faststore/blob/v3.99.0-dev.0/dist/commands/start.js)_
...
_See code: [dist/commands/test.js](https://github.com/vtex/faststore/blob/v3.99.0-dev.0/dist/commands/test.js)_
<!-- commandsstop -->
