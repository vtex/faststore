...
export default class Generate extends Command {
  ...
  async run() {
    ...
    await generateSchemaFile(tmpDir)

    generateSchemaTSTypes(tmpDir)
...
async function generateSchemaFile(tmpDir: string) {
  ...
  const saveSchemaFile = saveFile(
    path.resolve(tmpDir, '@generated', schemaFileName)
  )
