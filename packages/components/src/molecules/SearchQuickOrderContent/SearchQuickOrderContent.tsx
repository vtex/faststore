...
const SearchQuickOrderContent = forwardRef<
  HTMLDivElement,
...
>(function SearchQuickOrderContent(
  ...
  return (
    <div
      ref={ref}
      data-fs-search-quick-order
      onClick={stopPropagationClick}
      {...otherProps}
    >
      <div data-fs-search-quick-order-content>
        {!availability && (
          <Badge data-fs-search-quick-order-badge variant="warning">
            Out of Stock
          </Badge>
        )}
      ...
      {availability && (
        <div
          data-fs-search-quick-order-actions
          role="group"
          onClick={stopPropagationClick}
        >
...
export default SearchQuickOrderContent
